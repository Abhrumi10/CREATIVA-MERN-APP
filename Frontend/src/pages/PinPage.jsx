        ...
        <div className="flex flex-col items-center bg-gray-100 p-4 min-h-screen">
          {loading ? (
            ...
            <div className="bg-white rounded-lg shadow-lg flex flex-wrap w-full max-w-4xl">
              <div className="w-full md:w-1/2 bg-white rounded-t-lg md:rounded-l-lg md:rounded-t-none flex items-center justify-center">
                {pin.image && (
                  <img
                    src={pin.image.url}
                    alt=""
              ...
              <div className="w-full md:w-1/2 p-6 flex flex-col ">
                <div className="flex items-center justify-between mb-4 ">
                  ...
                  {pin.owner && pin.owner._id === user._id && (
                    ...
                    className="bg-pink-700 text-white py-1 px-3 rounded"
                    >
                      <FaEdit />
                    </button>
                  )}
                ...
                {edit && (
                  <button
                    style={{ width: "200px" }}
                    className="bg-pink-700 text-white py-1 px-3 mt-2 mb-2"
                  ...
                  <div className="flex items-center justify-between border-b pb-4 mb-4">
                    <div className="flex items-center">
                      <Link to={`/user/${pin.owner._id}`}>
                        <div className="rounded-full h-12 w-12 bg-blue-200 flex items-center justify-center">
                ...
                <div className="flex items-center mt-4">
                  <div className="rounded-full h-12 w-12 bg-blue-200 flex items-center justify-center mr-4">
                    <span className="text-2xl font-bold text-pink-800">
                  ...
                  <form className="flex-1 flex" onSubmit={submitHandler}>
                    ...
                    <button
                      type="submit"
                      className="ml-2 bg-pink-700 font-semibold text-lg px-4 py-2 rounded-md text-white"
                    >
                      ADD
                    </button>
                  </form>
